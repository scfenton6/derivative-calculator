...
class Tokenizer:
    ...
    def handle_alpha_seq(self):
        """Determine whether or not our sequence of alpha characters
        is a variable or a valid function."""
    ...
    def handle_asterisk(self):
        ...
        represent the power operator, and in the latter it
        would represent the product operator"""
